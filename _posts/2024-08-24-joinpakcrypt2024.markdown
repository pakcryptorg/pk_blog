...
date:   2024-10-26 07:22:34 +0500
categories: comp e3
permalink: ./pcc24
---

## IMPORTANT NOTE
The first two rounds have been completed.

We are now compiling results to select PakCrypt 2024 finalists.
...
| Round 2 | Selection of ~35x Finalists | 28 Oct, 2024 |
| Final | On-Campus Competition & Closing Cermony | 13-14 Nov, 2024 |
|---|---|---|

## List of Finalists
Congrats on making it to the finals of the All Pakistan Cryptography Competition! 
Out of nearly 900 participants, you’ve secured a spot among the top contenders. 
We can’t wait to see you bring your best to the final round. Good luck!
# Professional Track
The professional competition is an individual event. The list below are in no specific order.

| Name | Association | City |
|---|---|---|
|Mehmood ul Hassan 	|FAST	|Islamabad |
|Mehak Usman	|NUST	|Karachi|
|Muhammad Ahmed Raza	|Bahria University 	|Rawalpindi|
|Nasir Ali	|Bahria University 	|Islamabad|
|Duaa Aamir	|FAST	|Rawalpindi|
|Muhammad Moarij Ali 	|FAST	|Islamabad|
|Umer Farooq	|FAST	|Muzaffarabad |
|Syed Basim Mehmood	|GIKI	|Karachi|
|Burhan ud din 	|FAST	|Islamabad |
|Maheen Khalid	|UET, Taxila	|Rawalpindi|
|Waleed Ahmed	|NASTP	|Rawalpindi|
|Warda Altaf	|Jinnah University	|Karachi|
|Syeda Afia Shah	|UET, Peshawar	|Peshawar|
|Muhammad Zeeshan	|Islamia University 	|Lodhran|
|---|---|---|
...
You may request a preferred teammate, though approval is not guaranteed. Team announcements will be made on the event day.
The list below are in no specific order.

| Name | Association | City |
|---|---|---|
|	Zainab Kayani	|	FAST	|	Rawalpindi	|
|	Tooba Naeem Sattar 	|	CITY School	|	Faisalabad 	|
|	Syed Ali Shah	|	FAST	|	Rawalpindi	|
|	Syed M. Kazim Raza Jafferi	|	SuperNova School	|	Islamabad	|
|	Ayesha Salyana	|	Siddeeq Public School	|	Islamabad	|
|	Syed Badar Ul Islam Shah	|	LGS, Wah Cantt	|	Haripur	|
|	Sami Shahbaz	|	SundarSTEM School	|	Lahore	|
|	Syed Shuja Haider	|	SundarSTEM School	|	Lahore	|
|	Abiha Azhar	|	Siddeeq Public School 	|	Islamabad 	|
|	Hissan Kibria	|	Cadet College Hassanabdal	|	Hassanabdal	|
|	Muhammad Safiullah	|	Mehran UET	|	Hyderabad	|
|	Mohammad Arslan	|	Cadet College Hasanabdal	|	Hasanabdal	|
|	Muhammad Arhum Shahid	|	SundarStem School	|	Lahore	|
|	Muhammad Ahmad Bhatti	|	Karachi Grammar School	|	Karachi	|
|	Khawaja Assam Arif	|	Sundar STEM School	|	Lahore	|
|	Muhammad Aneeq	|	SundarSTEM School	|	Lahore	|
|	Ahmed Imran Malik	|	Sundar STEM School	|	Lahore	|
|	Maisha Shaikh	|	Siddeeq Public School 	|	Islamabad	|
|	Muhammad Saad Munir	|	Aitchison College Lahore	|	Lahore	|
|	M.  Ghulam Mohiuddin	|	SundarSTEM	|	Lahore	|
|	RUBAB IBRAHIM 	|	Islamabad Career College 	|	Islamabad 	|
|	Wanya Sajjad 	|	Siddeeq Public School 	|	Rawalpindi 	|
|	Fatima Khalid	|	Punjab College	|	Islamabad	|
|	Abeeha Noor	|	KIPS College	|	Wah cantt	|
|---|---|---|
